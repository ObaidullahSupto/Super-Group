                           ...
                           <div class="">
                              <nav class="navigation navigation-simple navigation--left">
                                 <ul class="navigation__ul">
                                    ...
                                    <li class="navigation__li ">
                                       <a href="{{ URL::asset('concerns/concern5/index') }}" class="navigation__anchor navigation__anchor--active">
                                          <span class="navigation__anchor-circle"></span>
                              ...
                              <section class="module-text
                                 ...
                                 <div class="text-area ">
                                    <h2 class="headline headline--medium"><span
                                          class="dash dash--after rte-color--orange">Elite Properties Management
                                          Ltd</span></h2>
                                    ...
                                    <p>In recent years, the real estate sector in Bangladesh has experienced
                                       considerable growth and development, with high-rise buildings, offices and urban
                                       growth of housing in Dhaka and Chittagong. We find this sector a crucial
                                       benchmark to evaluate the progress of our country. Increase in housing and
                                       building demands in metropolitan cities are a sign of growing urbanization, which
                                       has an overall positive impact on the economic growth of our country.
                                       After careful analysis, Super has decided to enter this sector last year with our
                                       first housing project in South Khulshi, Chittagong.

                                       We do not compromise on the quality of our buildings, and our primary objective
                                       before commencement of construction is ensuring that the safety of the project is
                                       ensured. We take into consideration the location of the site, the benefits to
                                       surrounding neighbourhoods, using the best construction materials and at the same
                                       time keeping in touch with modern trends and customer needs and wants.</p>
