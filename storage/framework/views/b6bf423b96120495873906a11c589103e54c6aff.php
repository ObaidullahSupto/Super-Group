      ...
      <div class="container">
         <div class="row">
            <div class="col-xs-4">
            <a href="<?php echo e(URL::asset('/')); ?>" class="logo-change"></a> <!-- this is for logo changing -->
               ...
               <!-- <form action="#" method="post" class="form form--rounded-corners theme--light main-nav__search">
                  ...
                  <button name="submit" type="submit" class="main-nav__search-btn">
                     <svg class="icon icon--search">
                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="<?php echo e(URL::asset('images/icons.svg#icon-search')); ?>">
                        </use>
                     </svg>
                  </button>
               </form> -->
                  ...
                  <div class="main-nav__contact">
                     ...
                     <div class="main-nav__contact-press">
                        ...
                        <ul class="main-nav__contact-list">
                           <li class="main-nav__contact-list-item">
                              <svg class="icon">
                                 <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                    xlink:href="<?php echo e(URL::asset('images/icons.svg#icon_person')); ?>"></use>
                              </svg>
                           ...
                           <li class="main-nav__contact-list-item">
                              <svg class="icon">
                                 <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                    xlink:href="<?php echo e(URL::asset('images/icons.svg#ikoner_telefon')); ?>"></use>
                              </svg>
                           ...
                           <li class="main-nav__contact-list-item">
                              <svg class="icon">
                                 <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                    xlink:href="<?php echo e(URL::asset('images/icons.svg#ikoner_mail')); ?>"></use>
                              </svg>
                     ...
                     <div class="social">
                        <a href="https://www.facebook.com/supergroupbd/">
                           <img src="<?php echo e(URL::asset('images/media/logo/fb.png')); ?>">
                        </a>
                        <a href="https://www.instagram.com/be_betterenergy/">
                           <img src="<?php echo e(URL::asset('images/media/logo/inst.png')); ?>">
                        </a>
                        <a href="https://dk.linkedin.com/company/be-better-energy">
                           <img src="<?php echo e(URL::asset('images/media/logo/linkedin.png')); ?>">
                        </a>
                     </div>
                  </div>
               </div>
                  ...
                  <nav class="navigation navigation-simple navigation--theme-light navigation--right navigation--large">
                     <ul class="navigation__ul">
                       <!--  <li class="navigation__li navigation__li">
                           <a href="<?php echo e(URL::asset('news/index')); ?>" class="navigation__anchor navigation__anchor">
                        ...
                        <li class="navigation__li navigation__li--parent">
                           ...
                           <ul class="navigation__sub-ul">
                              <li class="navigation__sub-li">
                                 <a href="<?php echo e(URL::asset('concerns/concern1/index')); ?>" class="navigation__sub-anchor">SUPER REFINERY
                                    (PVT.) Limited</a>
                              </li>
                              <li class="navigation__sub-li">
                                 <a href="<?php echo e(URL::asset('concerns/concern2/index')); ?>" class="navigation__sub-anchor">Super Tel Limited</a>
                              </li>
                               <li class="navigation__sub-li">
                                 <a href="<?php echo e(URL::asset('concerns/concern6/index')); ?>" class="navigation__sub-anchor">Super Shares &
                                    Securities Limited</a>
                              </li>                              
                              <li class="navigation__sub-li">
                                 <a href="<?php echo e(URL::asset('concerns/concern3/index')); ?>" class="navigation__sub-anchor">Super Sea Fish
                                    (Pvt.) Limited</a>
                              </li>
                              <li class="navigation__sub-li">
                                 <a href="<?php echo e(URL::asset('concerns/concern4/index')); ?>" class="navigation__sub-anchor">Elite Super
                                    Plastic Ind. (Pvt) Limited</a>
                              </li>
                              <li class="navigation__sub-li">
                                 <a href="<?php echo e(URL::asset('concerns/concern5/index')); ?>" class="navigation__sub-anchor">Elite Properties
                        ...
                        <li class="navigation__li navigation__li--parent">
                           ...
                           <ul class="navigation__sub-ul">
                               <li class="navigation__sub-li">
                                 <a href="<?php echo e(URL::asset('about-us/profile/index')); ?>" class="navigation__sub-anchor">Details</a>
                              </li>
                              <li class="navigation__sub-li">
                                 <a href="<?php echo e(URL::asset('about-us/manifesto/index')); ?>" class="navigation__sub-anchor">Our History</a>
                              </li>
                             <!--  <li class="navigation__sub-li">
                                 <a href="<?php echo e(URL::asset('about-us/careers/index')); ?>" class="navigation__sub-anchor">Careers</a>
                              </li>  -->                           
                             
                               <!--  <li class="navigation__sub-li">
                                 <a href="<?php echo e(URL::asset('about-us/annual-reports/index')); ?>" class="navigation__sub-anchor">Annual Reports</a>
                              </li> -->
                              <!-- <li class="navigation__sub-li">
                                 <a href="<?php echo e(URL::asset('about-us/people/index')); ?>" class="navigation__sub-anchor">People</a>
                              </li> -->
                           </ul>
                        </li>
                        <!-- <li class="navigation__li navigation__li--parent">
                           <a href="<?php echo e(URL::asset('gallery/index')); ?>" class="navigation__anchor navigation__anchor">
                              <span class="navigation__anchor-circle"></span>
                        ...
                        <li class="navigation__li navigation__li">
                           <a href="<?php echo e(URL::asset('contact/index')); ?>" class="navigation__anchor navigation__anchor">
                              <span class="navigation__anchor-circle"></span>
...
<?php /**PATH /home/eclbikyu/public_html/nodejs/resources/views/includes/header.blade.php ENDPATH**/ ?>