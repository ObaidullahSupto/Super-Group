         ...
         <div>
            <section class="module-banner module-banner--sm">
               <figure class="module-banner__figure lazyload lazyload--background"
                  data-src="<?php echo e(URL::asset('images/media/1171/b1.jpg?width=1920')); ?>"
                  data-src-xs="<?php echo e(URL::asset('images/media/1171/b3.jpg?width=600')); ?>"
                  data-src-ms="<?php echo e(URL::asset('images/media/1171/b4.jpg?width=800')); ?>"
                  data-src-sm="<?php echo e(URL::asset('images/media/1171/b2.jpg?width=1024')); ?>"
                  data-src-md="<?php echo e(URL::asset('images/media/1171/b2.jpg?width=1024')); ?>">
               </figure>
                                 ...
                                 <nav class="navigation navigation-simple navigation--left">
                                    <ul class="navigation__ul">
                                       <li class="navigation__li ">
                                          <a href="<?php echo e(URL::asset('contact/index')); ?>" class="navigation__anchor navigation__anchor--active">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eclbikyu/public_html/nodejs/resources/views/contact/index.blade.php ENDPATH**/ ?>