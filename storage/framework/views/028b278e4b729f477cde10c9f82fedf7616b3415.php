<section class="search-result search-result--overlay">
   ...
   <script src="<?php echo e(URL::asset('js/scripts/polyfills.min.js')); ?>"></script>
   <script src="<?php echo e(URL::asset('js/scripts/vendor.min.js')); ?>"></script>
   <script src="<?php echo e(URL::asset('js/scripts/master.min.js')); ?>"></script>
   <script src="<?php echo e(URL::asset('js/script.js')); ?>"></script>
   <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.13.1/jquery.validate.min.js"></script>
   <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validation-unobtrusive/3.2.11/jquery.validate.unobtrusive.min.js"></script>
   <script src="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.2.1/owl.carousel.js"></script><?php /**PATH /home/eclbikyu/public_html/nodejs/resources/views/includes/footer-bottom.blade.php ENDPATH**/ ?>