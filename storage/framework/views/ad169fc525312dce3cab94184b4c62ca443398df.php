                           ...
                           <div class="">
                              <nav class="navigation navigation-simple navigation--left">
                                 <ul class="navigation__ul">
                                    ...
                                    <li class="navigation__li ">
                                       <a href="<?php echo e(URL::asset('concerns/concern2/index')); ?>" class="navigation__anchor navigation__anchor--active">
                                          <span class="navigation__anchor-circle"></span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eclbikyu/public_html/nodejs/resources/views/concerns/concern2/index.blade.php ENDPATH**/ ?>